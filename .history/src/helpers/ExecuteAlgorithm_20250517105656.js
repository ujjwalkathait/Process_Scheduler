...
const executeSelectedAlgorithm = (selectedAlgorithm, num_of_processes, processes, setProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses,setCurrentProcess) => {
