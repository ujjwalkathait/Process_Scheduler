...
const executeSelectedAlgorithm = (selectedAlgorithm, num_of_processes, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses,setCurrentProcess, isPaused) => {
    ...
    switch (selectedAlgorithm) {
        case FCFS:
            executeFCFS(processes, num_of_processes, setUpdatedProcesses,setCurrentProcess, getPaused);
            setExecuted(true);
