...
const executeSelectedAlgorithm = async (selectedAlgorithm, num_of_processes, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses,setCurrentProcess) => {
    ...
    switch (selectedAlgorithm) {
        case FCFS:
            await executeFCFS(processes, num_of_processes, setUpdatedProcesses,setCurrentProcess, get);
            setExecuted(true);
