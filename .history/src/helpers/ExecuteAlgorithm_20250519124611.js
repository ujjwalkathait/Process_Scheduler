...
const executeSelectedAlgorithm = (selectedAlgorithm, num_of_processes, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses,setCurrentProcess, setIsPaused) => {
    ...
    switch (selectedAlgorithm) {
        case FCFS:
            executeFCFS(processes, num_of_processes, setUpdatedProcesses,setCurrentProcess, getIsPaused);
            setExecuted(true);
