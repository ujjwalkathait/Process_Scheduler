...
export default function Simulate() {
  ...
  const handleStart = async () => {
    ...
    await executeSelectedAlgorithm(selectedAlgorithm, num_of_process, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses, setCurrentProcess);
    ...
    <div className="w-full bg-white my-6 flex flex-row gap-10">
      ...
      <div className="col-span-2 space-y-4">
        ...
        <div className="overflow-y-auto flex-shrink-0 max-h-[500px]">
          <ProcessProgressList 
            pprocesses={updatedProcesses.length ? updatedProcesses : processes}
          />
        </div>
      </div>
    </div>
