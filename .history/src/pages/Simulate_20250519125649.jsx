...
export default function Simulate() {
  ...
  const handleStart = () => {
    ...
    executeSelectedAlgorithm(selectedAlgorithm, num_of_process, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses, setCurrentProcess, setIsPaused);
  };
