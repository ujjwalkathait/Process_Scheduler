...
const ProcessData = ({processId, arrivalTime, burstTime, priority, processes, setProcessID, setProcesses, setUpdatedProcesses, setArrivalTime, setBurstTime, setPriority, selectedAlgorithm, setExecuted, setStatisticsData, setAnotherUpdatedProcesses, setCurrentProcess}) => {
        ...
        <form className='flex flex-col gap-[0.85rem] text-[0.9rem]'>
           ...
           <button 
            ...
            <button
                ...
                onClick={e => {
                    e.preventDefault();
                    executeSelectedAlgorithm(selectedAlgorithm, num_of_process, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses, setCurrentProcess);
                    // navigate('/simulate');
                }}
                onClick={e => {
                    e.preventDefault();
