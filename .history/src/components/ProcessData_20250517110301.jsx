        ...
        <form className='flex flex-col gap-[0.85rem] text-[0.9rem]'>
           ...
           <button 
            ...
            <button
                ...
                onClick={e => {
                    e.preventDefault();
                    executeSelectedAlgorithm(selectedAlgorithm, num_of_process, processes, setProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses, setCurrentProcess);
                    // navigate('/simulate');
                }}
            >
                Simulate
