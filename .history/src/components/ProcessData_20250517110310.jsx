...
const ProcessData = ({processId, arrivalTime, burstTime, priority, processes, setProcessID, setProcesses, setUpdatedProcesses, setArrivalTime, setBurstTime, setPriority, selectedAlgorithm, setExecuted, setStatisticsData, setCurrentProcess}) => {
