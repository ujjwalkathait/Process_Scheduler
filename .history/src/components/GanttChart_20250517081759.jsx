                        ...
                        <div className='flex flex-row justify-center'>
                            {processes.map(process => (
                                ...
                                >
                                    ...
                                    <div className={`text-[1rem] font-medium ${count===processes.length ? 'block' : 'hidden'}`}>{`${console.log(process.completionTime)}`}</div>
                                </div>
                            ))} 
                        </div>
                    )
                        ...
                        <div className='flex flex-row justify-center'>
                            {processes.map(process => (
                                ...
                                >
                                    ...
                                    <div className={`text-[0.8rem] font-medium ${count===processes.length? 'block' : 'hidden'}`}>{`${console.log(process.startTime)}`}</div>
