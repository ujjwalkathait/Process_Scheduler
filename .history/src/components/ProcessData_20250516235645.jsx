        ...
        <form className='flex flex-col gap-[0.85rem] text-[0.9rem]'>
           ...
           <button 
                ...
                onClick={e => {
                    ...
                    let burstTime1 = parseInt(burstTime);
                    let priority1 = parseInt(priority);

                    let created_process = { processId, arrivalTime1, burstTime1, priority1, startTime: 0, completionTime: 0, remainingTime: burstTime1};
