        ...
        <form className='flex flex-col gap-[0.85rem] text-[0.9rem]'>
           ...
           <button 
                ...
                onClick={e => {
                    ...
                    let created_process = { processId, arrivalTime: Number(arrivalTime),burstTime: Number(burstTime),
  priority: Number(priority), startTime: 0, completionTime: 0, remainingTime: Number(burstTime), waitingTime: 0};
