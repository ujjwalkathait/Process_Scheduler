...
// If there are less than 10 processes, fill the rest with empty objects
if (len < 10) {
    const emptyProcesses = Array.from({ length: 10 - len }, (_, i) => ({
        processId: `Empty${i + 1}`,
        remainingTime: 0,
        waitingTime: 0,
        burstTime: 0,
    }));
    processes = [...processes, ...emptyProcesses];
    }
