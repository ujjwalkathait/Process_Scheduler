                        ...
                        <div className='flex flex-row justify-center'>
                            {processes.map((process,index) => (
                                ...
                                >
                                    ...
                                    <div className={`text-[1rem] font-medium ${index===processes.length-1 ? 'block' : 'hidden'}`}>{`${process.completionTime}`}</div>
                                </div>
                            ))} 
                        </div>
                    )
                        ...
                        <div className='flex flex-row justify-center'>
                            {processes.map((process,index) => (
                                ...
                                >
                                    ...
                                    <div className={`text-[0.8rem] font-medium ${index===processes.length-1? 'block' : 'hidden'}`}>{`${process.completionTime}`}</div>
                                </div>
                            ))} 
                        </div>
                    )
