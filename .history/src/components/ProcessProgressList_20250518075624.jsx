  ...
  return (
    <div className="bg-black text-white border-2 rounded-lg p-4 w-full">
      ...
      <div className="grid grid-cols-[1fr_4fr_2fr_2fr] border-2 border-green-500 gap-2 font-semibold mb-2">
        <div className='text-al'>Processes</div>
        <div className='text-al'>Status Bar</div>
        <div className='text-al'>Remaining Burst Time</div>
        <div className='text-al'>Waiting Time</div>
      </div>
